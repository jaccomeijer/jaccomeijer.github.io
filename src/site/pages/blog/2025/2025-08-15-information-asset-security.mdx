...
This post explores how identifying and classifying information assets plays a
critical role in security. Simply put, the more an organization understands
about its assets, the better it can protect them. Unfortunately many
organizations lack a clear view of what assets they actually have which makes
effective protection a real challenge. This post offers a high level overview at
asset security and explains why it’s so essential.

Asset security connects to data security, which can be seen as a specific area
within the broader concept. More on that in the post below.
