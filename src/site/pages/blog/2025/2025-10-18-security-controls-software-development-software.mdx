...
controls could be added to an automated CI/CD pipeline.

Controls from compliancy standards like ISO 27002 are not added but by using AI,
a simple basic set can easily be generated. To make the list more actionable AI
can also be used to generate tool recommendations.
