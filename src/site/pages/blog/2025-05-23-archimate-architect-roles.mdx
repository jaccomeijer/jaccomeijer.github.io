...
This post uses the example roles from the TOGAF 10th edition Architecture Roles
and Skills Guide. The guide uses the three TOGAF viewpoints for managing an
