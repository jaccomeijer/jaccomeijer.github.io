...
All architects in a team use the motivation elements that drive the design of a
enterprise. These elements define things like requirements, principles and
drivers.
...
Motivation elements are at the core of the ArchiMate language. These elements guide
the change or the design of an enterprise and answer to the 'Why' in the
[Zachman framework](https://en.wikipedia.org/wiki/Zachman_Framework).

For example, a strategy elements can influence a motivation element like a goal.
Another example is a business or application element that realizes a principle
or a requirement.
...
Strategy elements model strategic elements of an architecture. The layer does
not contain service or interface elements because the abstraction level is
higher than the business layer.

For example, a capability can serve a value stream and a resource can be
assigned to a capability that realizes a motivation element like a goal.

<Picture 
  className="s-block-space u-block-space-l"
  src="/site/pages/blog/images-architecture/archimate-strategy.svg"
/>

#### Business elements

Business elements model the operation.

It could for example be used to describe how the customer role connects to a
business service or how a work process connects to a service on the application
layer.

<Picture 
  className="s-block-space u-block-space-s"
  src="/site/pages/blog/images-architecture/archimate-business.svg"
/>

#### Application elements

Applications are modeled with application elements.
...
<Picture 
  className="s-block-space u-block-space-s"
  src="/site/pages/blog/images-architecture/archimate-composite.svg"
/>
...
<div className="s-grid u-grid-three-cols u-gap-xs s-block-space u-block-space-l">
  <Picture 
    src="/site/pages/blog/images-architecture/archimate-relationship-dependency.svg"
  />

  <Picture 
    src="/site/pages/blog/images-architecture/archimate-relationship-structural.svg"
  />

  <Picture 
    src="/site/pages/blog/images-architecture/archimate-relationship-dynamic-other.svg"
  />
</div>
