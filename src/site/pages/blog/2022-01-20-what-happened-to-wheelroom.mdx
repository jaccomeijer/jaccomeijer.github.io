---
permalink: /blog/what-happened-to-wheelroom/
date: 2022-01-20
lastmod: 2024-03-27
tags: ['blog']
topics:
  opener:
    ...
    image: /site/pages/blog/images/2022-01-20-daniel-olah-VS_kFx4yF5g-unsplash.jpg
---
...
import { getOpenerTopicsByNavigationIds } from '../../helpers/get-opener-topics-by-navigation-ids'

## Wheelroom

Modelberry is the successor of Wheelroom. The original Wheelroom repository
might [still be online](https://github.com/wheelroom/wheelroom).
...
<Picture className="s-block-space u-block-space-s" src="/site/pages/blog/images/2022-01-20-Contentful-Gatsby-Netlify.png" />
...
The UI library was build around a React clone of styled-system.com (not online
anymore). This design system served well for a while but eventually evolved into
the Any Element.
...
<TopicList
  ...
  variant="card"
  topics={getOpenerTopicsByNavigationIds({
    collections: props.collections,
    navigationIds: ['naming-react-components', 'typescript-interface-for-react'],
  })}
/>

## Command line utility

The Wheelroom command line utility uses a javascript object for defining the
content models. The content models could be pushed to Contentful and were used
to generate typescript definitions and graphql queries.

This worked well, but there was a better way.
