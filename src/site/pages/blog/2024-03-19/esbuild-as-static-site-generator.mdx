...
topics:
  opener:
    ...
    image: '/site/pages/blog/2024-03-19/jj-ying-7JX0-bfiuxQ-unsplash.jpg'
---
...
<Topic
  variant="card"
  topic={getOpenerTopicByNavigationId({ collections: props.collections, navigationId: '11ty-and-github-pages' })}
  swapImage={true}
/>
...
<TopicList
  ...
  topics={getOpenerTopicsByNavigationIds({
    ...
    navigationIds: ['javascript-history', 'transpilers-bundlers-and-modules'],
  })}
  swapImage={true}
/>
...
<Topic
  variant="card"
  topic={getOpenerTopicByNavigationId({ collections: props.collections, navigationId: 'render-jsx-plugin' })}
  swapImage={true}
/>
