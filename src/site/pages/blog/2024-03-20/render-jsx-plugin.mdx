...
topics:
  opener:
    ...
    image: '/site/pages/blog/2024-03-20/dustin-humes-QvU179UC2Nw-unsplash.jpg'
---
...
is not online anymore and this breakdown is left here for reference.
...
<Topic
  variant="card"
  topic={getOpenerTopicByNavigationId({ collections: props.collections, navigationId: 'ui-library' })}
  swapImage={true}
/>
