---
navigation:
  url: /blog/contentful-netlify-and-gatsby-four-years-later
...
topics:
  opener:
    ...
    icon: message-circle
    image: contentModelingWithVariants
---
export { BlogLayout as default } from '../../../layout/blog-layout.jsx'
import { Picture, Topic } from '@jaccomeijer/green-lib'
...
<Topic
  data-variant="card"
  globals={globals}
  topic={getOpenerTopicByNavigationId({ pages: props.pages, navigationId: 'content-modeling-with-variants' })}
  images={blogImages}
  swap-image={true}
/>
