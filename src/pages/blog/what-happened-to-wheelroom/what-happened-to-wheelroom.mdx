...
lessons learned. This library uses [clear component
names](/blog/naming-react-components/) and a [component interface that prevents
breaking changes](/blog/typescript-interface-for-react-ui-components). The
library was separated from the command line utility.
