...
excremental Proof Of Concept. It is used to build this this site, it was used to
create the ui library, but the library itself is independent and can be used
with any JSX based framework, including [11ty](11ty.dev),
