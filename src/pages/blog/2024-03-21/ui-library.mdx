...
The library is in experimental use for this site and remains mostly a Proof Of
Concept. Some of the mainstream alternatives to this library are:

- [11ty with WebC](11ty.dev)
- [Nextjs with MDX](https://nextjs.org)
- [Astro with MDX](https://astro.build)

### Green build and lib

Github sources for this library are here. They're small and simple. Easy to
