---
navigation:
  url: /blog/versioning-strategy-for-npm-modules
...
topics:
  opener:
    ...
    icon: message-circle
    image: versioningStrategyForNpmModules
  splitModules:
...
a npm module with a [semantic version](https://semver.org). Each time the
...
<Topic
  data-variant="quote"
  globals={globals}
  topic={frontmatter.topics.splitModules}
/>
...
like [Lerna](https://github.com/lerna) and
[Jmmake](https://github.com/jaccomeijer/jmmake) can be configured to version the
packages as required.

<Topic
  data-variant="quote"
  globals={globals}
  topic={frontmatter.topics.monorepo}
/>
