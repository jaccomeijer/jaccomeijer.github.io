...
11ty. But, being familiar with Gatsby and React, how about JSX functions?
...
Many simple and lightweight JSX runtimes like [jeax](https://www.jeasx.dev)
exist. It is not needed to import the full React library.
