...
topics:
  opener:
    ...
    icon: message-square
    image: comparingBetweenReactAppNextjsAndGatsby
  createReactApp:
...
The most simple React app is a `<script>` tag on a HTML page. Add JSX, CSS
prefixing, type: entry-hyperlink id: 1a95ifdJHI6x1vQCDpHaCD and you have the
